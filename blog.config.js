...
// No -screen fonts such as '"lxgwwenkai"'
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,email,facebook,twitter,telegram,messenger,reddit,whatsapp,linkedin', // Share service, display in order, comma is separated
...
// Token: Webmention -like API TOKEN
  ...
  NOTION_PROPERTY_NAME: {
    password: process.env.NEXT_PUBLIC_NOTION_PROPERTY_PASSWORD || '',
  ...
  // Invalidation
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/Avatar.png', // The author's avatar is covered by the icon in Notion. If there is no icon, take Avatar.png in the Public directory
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '', // Site description, covered by page description in the note
  ...
  IMG_SHADOW: process.env.NEXT_PUBLIC_IMG_SHADOW || true, // Whether the picture picture is automatically added to the shadow
